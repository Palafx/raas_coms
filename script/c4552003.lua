...
function s.initial_effect(c)
	...
	c:RegisterEffect(e4)
	--This card's original ATK/DEF become 1000 x the cards in your hand
...
function s.defcon(e,tp,eg,ep,ev,re,r,rp)
	return not eg:IsContains(e:GetHandler()) and eg:IsExists(s.defilter,1,nil,tp)
end
